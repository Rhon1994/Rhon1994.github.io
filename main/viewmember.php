...
<td style="padding: 10px;
				...
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['asmkno']; ?></td>
</tr>
<tr>
<td> Full Name :  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['lastname']; ?> <?php echo $row['firstname']; ?> <?php echo $row['middleinitial']; ?> <?php echo $row['suffix']; ?></td>
</tr>
<tr>
<td> Address : </td>
<td style="padding: 10px;
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['sex']; ?></td>
</tr>
<tr>
<td> D.O.B:  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['bday']; ?></td>
</tr>
<tr>
<td> Contact No :  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['contactno']; ?></td>
</tr>
<tr>
<td> ID Num:  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['idnum']; ?></td>
</tr>
<tr>
<td> location :  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['location']; ?></td>
</tr>
